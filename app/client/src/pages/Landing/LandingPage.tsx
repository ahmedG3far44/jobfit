...
import { FileText, Sparkles, GitBranch, Download, ChevronDown, BadgeCheck } from 'lucide-react'
...
const features = [
  {
    ...
    description: 'Upload your master resumes and keep them organized in one place.',
  },
  {
    icon: Sparkles,
  ...
  },
  {
    ...
    description: 'Export your optimized resumes and cover letters as PDF or text.',
  },
]
    ...
    <div className="flex flex-col min-h-screen">
      <section className="flex-1 flex flex-col items-center justify-center px-4 py-24 text-center">
        ...
        <p className="mt-6 text-lg text-muted-foreground max-w-2xl">
          Upload your resume once. Generate ATS-optimized versions for every job application.
          Save hours of manual editing and land more interviews.
        </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {features.map((feature) => (
              <div key={feature.title} className="flex flex-col items-center text-center p-6 rounded-lg border bg-card">
      ...
      <section id="pricing" className="border-t py-20">
        <div className="mx-auto max-w-3xl text-center px-4">
          ...
          <div className="mx-auto max-w-sm rounded-lg border bg-card p-8 text-center">
            ...
            <p className="text-muted-foreground text-sm mb-6">Everything you need for your job search</p>
            <ul className="space-y-3 text-sm text-left mb-8">
              {['Unlimited master resumes', 'AI resume optimization', 'Version history', 'Cover letter generation', 'PDF & text export'].map((item) => (
